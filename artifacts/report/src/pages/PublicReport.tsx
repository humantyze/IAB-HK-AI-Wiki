    ...
    return (
      <div className="min-h-screen bg-white flex items-center justify-center">
        <div className="flex flex-col items-center space-y-4">
          <div className="w-10 h-10 border-2 border-[#199edb]/20 border-t-[#199edb] rounded-full animate-spin" />
  ...
  return (
    <div className="min-h-screen bg-white" style={{ fontFamily: 'Montserrat, sans-serif' }}>
      ...
      <div className="lg:hidden fixed top-0 left-0 right-0 h-16 bg-white z-50 border-b border-[#e5e7eb] flex items-center px-6 justify-between">
        ...
        <Button variant="ghost" size="icon" onClick={() => setSidebarOpen(!sidebarOpen)} style={{ color: '#199edb' }}>
      ...
      <section className="relative min-h-[70vh] flex items-center px-6 lg:px-24 pt-20 lg:pt-0 overflow-hidden bg-white border-b border-[#e5e7eb]">
        ...
        <div className="relative z-10 max-w-5xl py-20">
          ...
          >
            <div className="inline-flex items-center space-x-2 border border-[#199edb]/30 bg-[#199edb]/5 px-4 py-1.5 rounded-full mb-8">
              <span className="w-1.5 h-1.5 rounded-full bg-[#199edb]" />
              <span style={{ fontFamily: 'Montserrat', fontWeight: 600, fontSize: '10px', color: '#199edb', letterSpacing: '0.15em', textTransform: 'uppercase' }}>IAB Hong Kong Web Book</span>
            </div>
            ...
            <h1 style={{ fontFamily: 'Montserrat', fontWeight: 800, fontSize: '32px', color: '#3b3b3b', lineHeight: 1.2, marginBottom: '24px', letterSpacing: '-0.01em' }}>
              STATE OF AI IN{' '}
              <span style={{ color: '#199edb' }}>HONG KONG'S</span>{' '}
              MARKETING INDUSTRY
            </h1>
            ...
            <div className="flex flex-wrap items-center gap-4">
              <Button
                size="lg"
                style={{ backgroundColor: '#199edb', color: '#ffffff', borderRadius: '4px', fontFamily: 'Montserrat', fontWeight: 600, fontSize: '14px', letterSpacing: '0.05em', height: '48px', paddingLeft: '28px', paddingRight: '28px', border: 'none' }}
                onClick={() => {
              ...
              <Link href="/visual">
                <Button
                  size="lg"
                  variant="outline"
                  style={{ borderColor: '#199edb', color: '#199edb', backgroundColor: 'transparent', borderRadius: '4px', fontFamily: 'Montserrat', fontWeight: 600, fontSize: '14px', letterSpacing: '0.05em', height: '48px', paddingLeft: '28px', paddingRight: '28px' }}
                >
              ...
              <Link href="/admin/login">
                <span className="inline-flex items-center gap-2 cursor-pointer" style={{ color: '#B6B6B6', fontFamily: 'Montserrat', fontSize: '11px', letterSpacing: '0.15em', textTransform: 'uppercase', transition: 'color 0.2s' }}
                  onMouseEnter={e => (e.currentTarget.style.color = '#199edb')}
          ...
          <nav className="space-y-1">
            {sortedSections.map((section, idx) => (
              <button
                ...
                style={{
                  backgroundColor: activeSection === section.slug ? '#199edb10' : 'transparent',
                  borderLeft: `2px solid ${activeSection === section.slug ? '#199edb' : 'transparent'}`,
                }}
              >
                <span className="flex items-start">
                  <span style={{ fontFamily: 'Montserrat', fontWeight: 600, fontSize: '10px', color: activeSection === section.slug ? '#199edb' : '#B6B6B6', marginTop: '2px', marginRight: '12px', width: '16px', textAlign: 'right' }}>
                ...
                {activeSection === section.slug && (
                  <ChevronRight className="w-3.5 h-3.5 mt-0.5 shrink-0" style={{ color: '#199edb' }} />
                )}
              </button>
            ))}
          </nav>
            ...
            >
              <div className="relative max-w-4xl">
                ...
                {section.keyInsights && section.keyInsights.length > 0 && (
                  <div className="mb-10 p-6 rounded-xl border-l-4 border-[#199edb] bg-[#199edb]/5">
                    <h3 style={{ fontFamily: 'Montserrat', fontWeight: 700, fontSize: '11px', color: '#199edb', letterSpacing: '0.2em', textTransform: 'uppercase', marginBottom: '16px', display: 'flex', alignItems: 'center', gap: '8px' }}>
                    ...
                    <ul className="space-y-4">
                      {section.keyInsights.map((insight, i) => (
                        <li key={i} className="flex items-start gap-3">
                          <span style={{ fontFamily: 'Montserrat', fontWeight: 600, fontSize: '10px', color: '#199edb', marginTop: '2px', minWidth: '20px' }}>0{i + 1}</span>
                ...
                >
                  <style>{`
                    ...
                    .prose a { color: #199edb; text-decoration: underline; text-underline-offset: 3px; }
                    .prose a:hover { color: #337ab7; }
